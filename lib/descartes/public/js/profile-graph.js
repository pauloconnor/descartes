...
var renderTags = function() {
  gatherTags(function(tags) { 
    ...
    if ((typeof tags === 'object') && (tags.length > 0)) {
      for (var i in tags) {
        $('div.tags-wrapper div.tags ul').append('<li class="tag" id="' + tags[i].id + '"><a class="tag_delete" href="#"><i class="glyphicon-minus-sign"></i></a> ' + tags[i].name + '</li>');
      }
    }
    $('div.tags-wrapper div.tags ul').append('<li class="tag"><a class="tag_add" href="#"><i class="glyphicon-plus-sign"></i></a> <span class="tag_add">Add a new tag...</span></li>');
  });
};
